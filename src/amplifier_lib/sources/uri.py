"""URI parsing and resolved source data types for bundle source resolution.

Consolidates ParsedURI, ResolvedSource, and parse_uri in one place,
rather than splitting across a separate paths/ module.
"""
