"""Protocol definitions for source resolution."""
...
class SourceResolverProtocol(Protocol):
    ...
    SimpleSourceResolver provides a complete implementation with handlers
    for all standard URI schemes. Apps may extend with additional source
    types or custom caching strategies.
    """
...
class SourceHandlerWithStatusProtocol(Protocol):
    ...
    GitSourceHandler implements this protocol.
    """
